...
def _normalize_panels(
    ...
    for idx, panel in enumerate(panels, start=1):
        ...
        # Keep characters exactly as the model returned them; cast filtering for image
        # prompts happens in prompter._format_character_details.
        normalized.append(
            Panel(
                index=idx,
...
def write_script(
    ...
    *,
    ...
    # Normalize panel indices; preserve model-generated character lists as-is.
