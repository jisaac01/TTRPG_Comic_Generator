...
MASTER_BEATER_VIGNETTE_SYSTEM_PROMPT_FILENAME = "master_beater_vignette_system.txt"
MASTER_BEATER_VIGNETTE_USER_PROMPT_FILENAME = "master_beater_vignette_user.txt"
