...
## Procedure
1. Run the focused test selection immediately in a terminal using the workspace venv interpreter.
2. Use this form: `.venv/bin/python -m pytest -q <selector>`
...
- `.venv/bin/python -m pytest -q tests/test_prompter.py`
